...
<section class="grid grid-cols-1 lg:grid-cols-12 gap-5 items-stretch">
	...
	<!-- Quick Insights -->
	<div class="lg:col-span-4 bg-white border border-slate-200 rounded-xl shadow-xs overflow-hidden">
		<div class="p-5 border-b border-slate-100 bg-slate-50/20">
						...
						<tr class="hover:bg-slate-50/50 transition-colors">
							...
							<td class="py-3.5 px-5">
								<div class="flex items-center justify-center gap-2">
									...
									<button
										onclick={() =>
											triggerToast(`Removed student ${student.name} from records.`, 'danger')}
										aria-label="Remove student"
										class="p-1.5 border border-slate-200 text-slate-500 hover:text-rose-600 hover:bg-rose-50 hover:border-rose-200 rounded-lg transition-colors focus:outline-none"
									>
										<svg
											xmlns="http://www.w3.org/2000/svg"
											fill="none"
		...
		>
			...
			<div class="p-4 border-t border-slate-100 flex items-center justify-end gap-3 bg-slate-50/20">
				...
				<button
					...
					class="px-4 py-2 text-xs font-bold text-white bg-[#881B1B] hover:bg-[#881B1B]/90 rounded-lg transition-colors focus:outline-none shadow-xs"
				>
					Send Notice
				</button>
			</div>
